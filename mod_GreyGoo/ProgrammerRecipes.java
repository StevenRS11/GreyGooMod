...
public class ProgrammerRecipes
{
    private static final ProgrammerRecipes smeltingBase = new ProgrammerRecipes();

    private Map smeltingList = new HashMap();
    private Map experienceList = new HashMap();
    private Map metaSmeltingList = new HashMap();

    public static final ProgrammerRecipes smelting()
    {
        return smeltingBase;
    }

    private ProgrammerRecipes()
    {
        ...
        this.addSmelting(mod_GreyGoo.ItemModifierGrey.itemID, mod_GreyGoo.ItemModifierGreen.itemID, new ItemStack(mod_GreyGoo.ItemMatrixGreen), 0.7F);
        this.addSmelting(mod_GreyGoo.ItemModifierRed.itemID, mod_GreyGoo.ItemModifierGreen.itemID, new ItemStack(mod_GreyGoo.ItemMatrixGrey), 0.7F);
        ...
        this.addSmelting(mod_GreyGoo.ItemModifierRed.itemID, mod_GreyGoo.ItemModifierWhite.itemID, new ItemStack(mod_GreyGoo.ItemMatrixWhiteGreen), 0.7F);
        ...
        this.addSmelting(mod_GreyGoo.ItemModifierGreen.itemID, mod_GreyGoo.ItemModifierWhite.itemID, new ItemStack(mod_GreyGoo.ItemMatrixGrey), 0.7F);
        ...
        this.addSmelting(mod_GreyGoo.ItemModifierWhite.itemID, mod_GreyGoo.ItemModifierOrange.itemID, new ItemStack(mod_GreyGoo.ItemMatrixGrey), 0.7F);
        this.addSmelting(mod_GreyGoo.ItemModifierOrange.itemID, mod_GreyGoo.ItemModifierOrange.itemID, new ItemStack(mod_GreyGoo.ItemMatrixOrange), 0.7F);
        ...
        this.addSmelting(mod_GreyGoo.ItemModifierOrange.itemID, mod_GreyGoo.ItemModifierPurple.itemID, new ItemStack(mod_GreyGoo.ItemMatrixGrey), 0.7F);
        this.addSmelting(mod_GreyGoo.ItemModifierPurple.itemID, mod_GreyGoo.ItemModifierPurple.itemID, new ItemStack(mod_GreyGoo.ItemMatrixPurple), 0.7F);
