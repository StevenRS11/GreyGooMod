...
public class ContainerAssembler extends Container
{
    ...
    public ContainerAssembler(InventoryPlayer par1InventoryPlayer, TileEntityAssembler par2TileEntityAssembler)
    {
        ...
        this.addSlotToContainer(new Slot(par2TileEntityAssembler, 0, 50, 35 + 18));
        this.addSlotToContainer(new Slot(par2TileEntityAssembler, 1, 50, 35 - 18));
    ...
    public void addCraftingToCrafters(ICrafting par1ICrafting)
    {
        ...
        par1ICrafting.sendProgressBarUpdate(this, 1, this.Assembler.AssemblerCookTime);
        par1ICrafting.sendProgressBarUpdate(this, 0, this.Assembler.AssemblerCookTime);
    }
    @Override
    ...
    public void detectAndSendChanges()
    {
        ...
        while (var1.hasNext())
        {
            ...
            if (this.lastBurnTime != this.Assembler.AssemblerCookTime)
            {
                var2.sendProgressBarUpdate(this, 1, this.Assembler.AssemblerCookTime);
            }
        }

        this.lastBurnTime = this.Assembler.AssemblerCookTime;
    }
    ...
    public void updateProgressBar(int par1, int par2)
    {
        if (par1 == 1)
        {
            this.Assembler.AssemblerCookTime = par2;
        }
    }
    ...
    public ItemStack func_82846_b(EntityPlayer par1EntityPlayer, int par1)
    {
        ...
        if (var3 != null && var3.getHasStack())
        {
            ...
            {
                if (TileEntityAssembler.isItemFuel(var4))
                {
