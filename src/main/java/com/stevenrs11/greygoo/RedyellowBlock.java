...
public class RedyellowBlock extends FallingBlock {
    ...
    protected void falling(FallingBlockEntity entity) {
        ...
        if (!level.isClientSide) {
            spread((ServerLevel) level, entity.blockPosition());
        }
        super.falling(entity);
    }

    @Override
    public void onLand(Level level, BlockPos pos, BlockState fallingState, BlockState state, FallingBlockEntity entity) {
        if (!level.isClientSide) {
